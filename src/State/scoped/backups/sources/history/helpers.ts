...
import type { HistoryCursor, OpKey, SourceActualOperation, SourceOperation, SourceOperationBase, SourceOptimsiticInvoice } from "./types";
...
export const payInvoiceReponseToUserOperation = (resp: Omit<PayInvoiceResponse, "latest_balance">, optimisticOperation: SourceOptimsiticInvoice): UserOperation => {
...
export function getPaymentStateResponseToUserOperation(
	...
	return {
		...
		type: UserOperationType.OUTGOING_INVOICE,
		identifier: invoice,
		amount: resp.amount as Satoshi,
		paidAtUnix: resp.paid_at_unix,
		service_fee: resp.service_fee,
		network_fee: resp.network_fee,
		inbound: false,
		internal: resp.internal,
		confirmed: resp.paid_at_unix > 0,
		tx_hash: "",
	};
}
