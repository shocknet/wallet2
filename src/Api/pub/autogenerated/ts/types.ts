...
export type AdminMethodInputs = LndGetInfo_Input | AddApp_Input | AuthApp_Input | BanUser_Input | GetSeed_Input | CreateOneTimeInviteLink_Input | GetInviteLinkState_Input
export type AdminMethodOutputs = LndGetInfo_Output | AddApp_Output | AuthApp_Output | BanUser_Output | GetSeed_Output | CreateOneTimeInviteLink_Output | GetInviteLinkState_Output
