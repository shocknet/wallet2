...
export type UserMethodInputs = EnrollAdminToken_Input | UserHealth_Input | GetUserInfo_Input | AddProduct_Input | NewProductInvoice_Input | GetUserOperations_Input | NewAddress_Input | PayAddress_Input | NewInvoice_Input | DecodeInvoice_Input | PayInvoice_Input | GetPaymentState_Input | OpenChannel_Input | GetLnurlWithdrawLink_Input | GetLnurlPayLink_Input | GetLNURLChannelLink_Input
...
export type AdminMethodInputs = LndGetInfo_Input | AddApp_Input | AuthApp_Input | BanUser_Input | GetSeed_Input | ListChannels_Input | CreateOneTimeInviteLink_Input | GetInviteLinkState_Input
export type AdminMethodOutputs = LndGetInfo_Output | AddApp_Output | AuthApp_Output | BanUser_Output | GetSeed_Output | ListChannels_Output | CreateOneTimeInviteLink_Output | GetInviteLinkState_Output
...
export type AppsMetricsRequestOptionalField = 'include_operations' | 'from_unix' | 'to_unix'
export const AppsMetricsRequestOptionalFields: AppsMetricsRequestOptionalField[] = ['include_operations', 'from_unix', 'to_unix']
