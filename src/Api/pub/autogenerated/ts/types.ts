...
export type AdminMethodInputs = LndGetInfo_Input | AddApp_Input | AuthApp_Input | BanUser_Input
export type AdminMethodOutputs = LndGetInfo_Output | AddApp_Output | AuthApp_Output | BanUser_Output
...
export type ServerMethods = {
    ...
    LinkNPubThroughToken?: (req: LinkNPubThroughToken_Input & { ctx: UserContext }) => Promise<void>
...
export type AppsMetricsRequestOptionalField = 'to_unix' | 'include_operations' | 'from_unix'
export const AppsMetricsRequestOptionalFields: AppsMetricsRequestOptionalField[] = ['to_unix', 'include_operations', 'from_unix']
