...
export type AddGuestAppUser_Query = {
}
export type AddGuestAppUser_RouteParams = {
}
export type AddGuestAppUser_Context = AddGuestAppUser_Query & AddGuestAppUser_RouteParams & GuestContext
...
export type ServerMethods = {
    ...
    AddGuestAppUser?: (ctx: AddGuestAppUser_Context, req: AddGuestAppUserRequest) => Promise<AppUser>
...
export type AddGuestAppUserRequest = {
    app_id: string
    identifier: string
    fail_if_exists: boolean
}
export const AddGuestAppUserRequestOptionalFields: [] = []
export type AddGuestAppUserRequestOptions = OptionsBaseMessage & {
    checkOptionalsAreSet?: []
    app_id_CustomCheck?: (v: string) => boolean
    identifier_CustomCheck?: (v: string) => boolean
    fail_if_exists_CustomCheck?: (v: boolean) => boolean
}
export const AddGuestAppUserRequestValidate = (o?: AddGuestAppUserRequest, opts: AddGuestAppUserRequestOptions = {}, path: string = 'AddGuestAppUserRequest::root.'): Error | null => {
    if (opts.checkOptionalsAreSet && opts.allOptionalsAreSet) return new Error(path + ': only one of checkOptionalsAreSet or allOptionalNonDefault can be set for each message')
    if (typeof o !== 'object' || o === null) return new Error(path + ': object is not an instance of an object or is null')
