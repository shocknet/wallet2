...
export type ServerMethods = {
    ...
    GetLiveUserOperations?: (req: GetLiveUserOperations_Input & {ctx: UserContext }) => Promise<LiveUserOperation>
    GetMigrationUpdate?: (req: GetMigrationUpdate_Input & {ctx: UserContext }) => Promise<MigrationUpdate>
}
