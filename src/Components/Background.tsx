...
export const Background = () => {
	...
	const checkClipboard = useCallback(async () => {
		...
		const isCopiedFromWallet = !(utility.getCookie("lastCopiedAddr") === text);
		const isLastAsked = !(utility.getCookie("lastAsked") === text);

		if ((boolAddress || boolLnInvoice || boolLnAddress || boolLnurl) && isCopiedFromWallet && isLastAsked) {
			setClipText(text);
			toggle();
			utility.setCookie('lastAsked', text, 1);
		}
