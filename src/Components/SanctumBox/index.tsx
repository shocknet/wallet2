...
const SanctumBox = ({ loggedIn, successCallback, errorCallback, sanctumUrl }: Props) => {
	...
	const [deprecationNotice, setDeprecationNotice] = useState<DeprecationNotice | null>(null);
	...
	return (
		<div className={classNames({
			...
			{deprecationNotice && (
				<div className={styles["deprecation-notice"]} role="status" aria-live="polite">
					<div className={styles["deprecation-title"]}>
						{deprecationNotice.deprecated ? "Deprecation notice" : "Notice"}
					</div>
					<div className={styles["deprecation-message"]}>{deprecationNotice.message}</div>
				</div>
			)}
			<AnimatePresence>
