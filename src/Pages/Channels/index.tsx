...
const Channels = () => {
	...
	useEffect(() => {
		fetchChannels({ pubkey: adminSource.lpk, relays: adminSource.relays }, adminSource.keys)
	}, [adminSource])
	...
	return (
		<IonPage className="ion-page-width">
			<IonHeader className="ion-no-border">
				<MetricsSubPageToolbar title="Channels" />
			</IonHeader>
			<IonContent className="ion-padding ion-content-no-footer">
              ...
              Remote`}
					...
					<OpenChannelComponent adminSource={adminSource} />
					<EditChannel adminSource={adminSource} selectedChannel={selectedChannel} deselect={() => setSelectedChannel(null)} />
