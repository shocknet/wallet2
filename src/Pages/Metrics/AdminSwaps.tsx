...
import { SwapOperation, SwapsList, TransactionSwapQuote } from "../../Api/pub/autogenerated/ts/types";
...
export default function AdminSwaps() {
    ...
    return <IonPage className="ion-page-width">
        ...
        <IonContent className="ion-padding ion-content-no-footer">
            ...
            {swaps.quotes.length > 0 && <IonRow><IonText className="ion-margin-top" style={{ fontSize: "1.2rem", fontWeight: "bold" }}>Old Qoutes</IonText></IonRow>}
