...
import { IonButton, IonItem, IonPage, IonHeader, useIonLoading, useIonRouter, IonRow, IonText, IonInput, IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonBadge, IonIcon } from "@ionic/react";
...
export default function TxSwaps({ adminSource }: { adminSource: SourceView | undefined }) {
