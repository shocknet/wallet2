...
import { IonButton, IonItem, IonPage, IonHeader, useIonLoading, IonRow, IonText, IonInput, IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonBadge, IonIcon } from "@ionic/react";
...
export default function TxSwaps({ adminSource }: { adminSource: AdminRpcSource | null }) {
