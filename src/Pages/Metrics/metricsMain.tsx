...
const Dashboard = () => {
	...
	useIonViewWillEnter(() => {
		const ensureSourceReady = async () => {
			await dismissLoading();

			switch (adminSource.beaconStale) {
				case "warmingUp":
					await presentLoading("Reconnecting...");
					return;
				case "stale":
					showAlert({
						message: "Source appears to be down"
					});
					return;
				case "fresh":
					await fetchMetrics();
				...
				<div className={styles["metrics-container"]}>
					...
					<div className={styles["section"]}>
						<div className='metric-footer'>
							<i>Connected to <br />{nip19.nprofileEncode({ pubkey: adminSource.lpk, relays: adminSource.relays })}</i>
						</div>
					</div>
				</div>
			</IonContent>
