...
export const fetchErrors = async (source: SourceView) => {
...
export const fetchBundleStats = async (source: SourceView) => {
    const c = await getNostrClient({ pubkey: source.lpk, relays: source.relays }, source.keys)
...
export const fetchUsageStats = async (source: SourceView) => {
    const c = await getNostrClient({ pubkey: source.lpk, relays: source.relays }, source.keys)
