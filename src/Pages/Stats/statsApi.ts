...
export const fetchErrors = async (source: SpendFrom) => {
...
export const fetchBundleStats = async (source: SpendFrom) => {
    const c = await getNostrClient(source.pasteField, source.keys)
...
export const fetchUsageStats = async (source: SpendFrom) => {
    const c = await getNostrClient(source.pasteField, source.keys)
