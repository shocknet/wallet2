...
export const fetchErrors = async (source: NprofileView) => {
...
export const fetchBundleStats = async (source: NprofileView) => {
    const c = await getNostrClient({ pubkey: source.lpk, relays: source.relays }, source.keys)
...
export const fetchUsageStats = async (source: NprofileView) => {
    const c = await getNostrClient({ pubkey: source.lpk, relays: source.relays }, source.keys)
