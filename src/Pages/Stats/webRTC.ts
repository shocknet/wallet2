...
import { decodeTLVDataPacket, parseTLbV } from "./tlv";
...
export const newWebRtcConnection = async (source: NprofileView, onReady: (sendFunc: (m: Types.SingleUsageMetricReq) => Promise<Uint8Array>) => void) => {
