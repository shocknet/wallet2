...
import { SourceView, selectSourceViews } from "@/State/scoped/backups/sources/selectors";
...
const Offers = () => {
	...
	const [selectedSource, setSelectedSource] = useState<SourceView>(() => {
		...
		const withBalance = sources.find(s => s.maxWithdrawableSats > 0);
			...
			<IonContent className="ion-padding">
				{
					isLoading ? (
						...
						<div style={{ height: "80%", width: "100%" }}>
							<EmptyState title="The selected source has no offers yet" />
						</div>
					)
				}
